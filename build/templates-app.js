...
angular.module("about/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("about/about.tpl.html",
    ...
    "	<nav>\n" +
    "		<a href=\"/home\" class=\"back\" title=\"Home\"><i class=\"icon-chevron-left\"></i>&nbsp;Home</a>\n" +
    "	</nav>\n" +
    ...
    "		<button class=\"nobg\" ng-click=\"expanded = !expanded\" title=\"View More\">\n" +
    "			<i class=\"icon-caret-down icon-large\" ng-hide=\"expanded\"></i>\n" +
    "			<i class=\"icon-caret-up icon-large\" ng-show=\"expanded\"></i>\n" +
    "		</button>\n" +
    "	</div>\n" +
    ...
    "			<h4>Contact Info</h4>\n" +
    "			<ul class=\"info\">\n" +
    "				<li><span>Mobile</span><a href=\"tel://1-312-380-5256\">312-380-5256</a></li>\n" +
    "				<li><span>Email</span><a href=\"mailto:thienpham.us@gmail.com\">thienpham.us@gmail.com</a></li>\n" +
    "			</ul>\n" +
    "			<ul class=\"social\">\n" +
    "				<li><a href=\"http://plus.google.com/102157534092095391789/about\" target=\"_blank\" title=\"Google Plus\"><i class=\"icon-google-plus-sign icon-2x\"></i></a></li><li><a href=\"http://www.facebook.com/thienpham.us\" target=\"_blank\" title=\"Facebook\"><i class=\"icon-facebook-sign icon-2x\"></i></a></li><li><a href=\"http://www.linkedin.com/in/thienpham\" target=\"_blank\"><i class=\"icon-linkedin-sign icon-2x\" title=\"Linkedin\"></i></a></li>\n" +
    "			</ul>\n" +
    "		</div>\n" +
    "	</div>\n" +
    "</div>\n" +
...
angular.module("projects/projects.large.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/projects.large.tpl.html",
    ...
    "	<div class=\"container\">\n" +
    "	<nav class=\"close\">\n" +
    "		<a href=\"project/{{project.id}}\" class=\"close\" title=\"Close\"><i class=\"icon-remove-sign\"></i>&nbsp;Close</a>\n" +
    "	</nav>\n" +
    ...
    "	</ul>\n" +
    "	<nav>\n" +
    "		<button class=\"btn nobg prev\" ng-click=\"currentImage = currentImage - 1\" ng-disabled=\"currentImage == 0\"><i class=\"icon-chevron-left\"></i>&nbsp;prev</button>\n" +
    "		<button class=\"btn nobg next\" ng-click=\"currentImage = currentImage + 1\" ng-disabled=\"currentImage == project.largeImages.length - 1\">next&nbsp;<i class=\"icon-chevron-right\"></i></button>\n" +
    "	</nav>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>");
...
angular.module("projects/projects.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/projects.view.tpl.html",
    ...
    "<div class=\"project\">\n" +
    "	<nav class=\"back\">\n" +
    "		<a href=\"/home\" class=\"back\" title=\"\"><i class=\"icon-chevron-left\"></i>&nbsp;Back</a>\n" +
    "	</nav>\n" +
    "	<ul rn-carousel rn-carousel-index=\"currentImage\" rn-carousel-indicator=\"true\" class=\"image\">\n" +
    ...
    "	</ul>\n" +
    "	<nav>\n" +
    "		<button class=\"nobg\" ng-click=\"currentImage = currentImage - 1\" ng-disabled=\"currentImage == 0\" title=\"Previous\"><i class=\"icon-chevron-left\"></i>&nbsp;prev</button>\n" +
    "		<button class=\"nobg\" ng-click=\"currentImage = currentImage + 1\" ng-disabled=\"currentImage == project.images.length - 1\" title=\"Next\">next&nbsp;<i class=\"icon-chevron-right\"></i></button>\n" +
    "		<a ng-href=\"project/{{project.id}}/large\" class=\"gray-icon\" ng-hide=\"siteLink\" title=\"View Larger\"><i class=\"icon-resize-full\"></i></a>\n" +
    "		<a ng-href=\"{{project.url}}\" class=\"gray-icon\" ng-show=\"siteLink\" title=\"View Site\" target=\"_blank\"><i class=\"icon-external-link\"></i></a>\n" +
    "	</nav>\n" +
    "	<div class=\"copy\">\n" +
    "	<h4>{{project.title}}</h4>\n" +
    "	<h5>{{project.subtitle}}</h5>\n" +
...
angular.module("resume/resume.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("resume/resume.tpl.html",
    ...
    "	<div class=\"row-fluid show-grid heading\">\n" +
    "		<h3>Thien Pham</h3>\n" +
    "		<h5>4321 Margery Dr &bull; Fremont, CA 94538</h5>\n" +
    "		<h5><a href=\"mailto:thiepham.us@gmail.com\" target=\"_blank\">thienpham.us@gmail.com</a> &bull; <a href=\"tel://1-312-380-5256\">(312) 380-5256</a></h5>\n" +
    "		<h5><a href=\"http://www.facebook.com/thienpham.us\">facebook</a> &bull; <a href=\"http://plus.google.com/102157534092095391789/about\">google+</a> &bull; <a href=\"http://www.linkedin.com/in/thienpham\" target=\"_blank\">linkedin</a></h5>\n" +
    "		<h5></h5>\n" +
    "		<a href=\"https://docs.google.com/file/d/0B0qdt7xwL6A8eVhrcEprQXdzTGc/edit?usp=sharing\" class=\"gray-icon\" title=\"Download Resume\" target=\"_blank\">\n" +
    ...
    "				<div class=\"row-fluid\">\n" +
    "					<h5 class=\"span4\">\n" +
    "						<div><strong>Allstate Financial</strong></div>\n" +
    "						<div><i>Multimedia Designer</i></div>\n" +
    "					</h5>\n" +
    "					<h5 class=\"span3 offset5\">\n" +
    "						<div>Chicago, IL</div>\n" +
    "						<div>Sep 2010&ndash;Apr 2013</div>\n" +
    "					</h5>\n" +
    "				</div>\n" +
    "				<ul>\n" +
    ...
    "				<div class=\"row-fluid\">\n" +
    "					<h5 class=\"span4\">\n" +
    "						<div><strong>Independent Consultant</strong></div>\n" +
    "						<div><i>Multimedia Designer</i></div>\n" +
    "					</h5>\n" +
    "					<h5 class=\"span3 offset5\">\n" +
    "						<div>Chicago, IL</div>\n" +
    "						<div>Nov 2007&ndash;Sep 2010</div>\n" +
    "					</h5>\n" +
    "				</div>\n" +
    "				<ul>\n" +
    ...
    "						<div><i>Visual Communications Designer</i></div>\n" +
    "					</h5>\n" +
    "					<h5 class=\"span3 offset5\">\n" +
    "						<div>Chicago, IL</div>\n" +
    "						<div>Mar 2006&ndash;Oct 2007</div>\n" +
    "					</h5>\n" +
    "				</div>\n" +
    "				<ul>\n" +
    ...
    "				<div class=\"row-fluid\">\n" +
    "					<h5 class=\"span4\">\n" +
    "						<div><strong>Raisenheadz Creative</strong></div>\n" +
    "						<div><i>Multimedia Production Artist</i></div>\n" +
    "					</h5>\n" +
    "					<h5 class=\"span3 offset5\">\n" +
    "						<div>Chicago, IL</div>\n" +
    "						<div>Nov 2003&ndash;Nov 2005</div>\n" +
    "					</h5>\n" +
    "				</div>\n" +
    "				<ul>\n" +
    ...
    "			<div class=\"row-fluid\">\n" +
    "				<h5 class=\"span4\">\n" +
    "					<div><strong>University of Wisconsin</strong></div>\n" +
    "					<div>BA Media Communications</div>\n" +
    "				</h5>\n" +
    "				<h5 class=\"span3 offset5\">\n" +
    "					<div>Madison, WI</div>\n" +
    "					<div>May 2002</div>\n" +
    "				</h5>\n" +
    "			</div>\n" +
    "			<h5><strong>Awards & Interests</strong></h5>\n" +
    "			<ul>\n" +
